...
function buscar( $smarty, $Conexion_ID, $PacienteIntervencion ) {
  ...
  if ($_POST["fechainicial"]){
    $Where[] = " fecha >= ". $miFecha->formatoDbFecha($_POST["fechainicial"]);
  }
  if ($_POST["fechafinal"]){
    $Where[] = " fecha <= ". $miFecha->formatoDbFecha($_POST["fechafinal"]);
  }
  if ($_POST["id_tpoperacion"]){
    $Where[] = " id_tpoperacion = ". $miFecha->formatoDbFecha($_POST["id_tpoperacion"]);
  }
