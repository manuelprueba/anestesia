...
<FORM METHOD="post" name="fresponsable" id="fresponsable" ACTION="CtrlUsuario.php">
<fieldset style="background-color : #e3e3e3">
<legend>Datos Usuarios</legend>
<table width="100%">
  <tr>
    <td width="15%"><b>Descripción:</b></td>
    <td align="left"><input type="text" name="sdescripcion" id="sdescripcion" size="30" value="{$sdescripcion}"><b>*</b></td>
  </tr>
  <tr>
